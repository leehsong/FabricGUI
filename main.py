...
class FabricAIApp(QtWidgets.QMainWindow, FabricUI.Ui_MainWindow):
    ratio = 1.0
    ...
    def __init__(self, parent=None):
        super(FabricAIApp, self).__init__(parent)
        ...
        self.textEdit.append("Start Fabric analsys program")
        self.textEdit.append("============================")
    ...
    def menuOpen(self):
        ...
        if height > 600:
            ...
            finalname ='textile_array_small.png'
    ...
    def btnCutImage(self):
        ...
        for x in self.Xcutlines:
            for y in self.Ycutlines:
                subimage = self.image[y0:y, x0:x, 0:3]
    ...
    def on_listclicked(self, index):
        ...
        if len(SelectedImage) > 0 :
            finalname = 'textile_selected.png'
    ...
    def btnSave(self):
        ...
        for key in self.subimages:
            it = key['name']
            filename = "subimages\\{fname}.png".format(fname=it)
            print(filename)
